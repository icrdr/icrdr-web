...
NRRDLoader.prototype = {
  ...
  parse: function (data) {
    ...
    //添加空间位移
    volume.offset = [
      -headerObject.space_origin[0] - spacingX * volume.xLength / 2,
      -headerObject.space_origin[1] - spacingY * volume.yLength / 2,
      parseFloat(headerObject.space_origin[2]) + parseFloat(spacingZ * volume.zLength / 2)
    ]
